<?php
	...
	$sql = array();
	array_push($sql, "CREATE TABLE IF NOT EXISTS `".$db_prefix."twitter_tweetmetadata` (`id` int(11) NOT NULL AUTO_INCREMENT,`twitter_tweet_id` bigint(20) NOT NULL,`request_id` INT NOT NULL,`field_key` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,`field_value` text CHARACTER SET utf8 COLLATE utf8_bin,PRIMARY KEY (`id`))");
	array_push($sql, "CREATE TABLE IF NOT EXISTS `".$db_prefix."twitter_tweets` (`id` bigint(20) NOT NULL,`user_id` BIGINT( 20 ) NOT NULL,`request_id` int(20) NOT NULL,PRIMARY KEY (`id`))");
	array_push($sql, "CREATE TABLE IF NOT EXISTS `".$db_prefix."twitter_usermetadata` (`id` int(11) NOT NULL AUTO_INCREMENT,`request_id` INT NOT NULL,`twitter_user_id` bigint(20) NOT NULL,`field_key` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,`field_value` text CHARACTER SET utf8 COLLATE utf8_bin,PRIMARY KEY (`id`))");
